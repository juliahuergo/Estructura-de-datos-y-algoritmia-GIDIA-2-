...
public:
    ...
    void duplicate(); //DOMJUDGE 4.1 DUPLICAR

    void mezclar(ListLinkedDouble& other); //DOMJUDGE ENTRAMAR
...
void ListLinkedDouble::duplicate() { //Coste lineal: O(n) donde n es el tamño de la lista
    Node* current = head->next;
